...
import { Smartphone, GitBranch, Zap, CheckCircle2, Search, Code, ShieldCheck, Terminal, Cpu } from 'lucide-react';
import AnimatedSection from './ui/AnimatedSection';

// --- VISUAL COMPONENTS ---

const StrategyVisual = () => (
  <div className="absolute right-0 top-0 w-full md:w-1/2 h-full min-h-[200px] overflow-hidden flex items-center justify-center p-4">
    ...
    <section className="py-24 bg-black relative overflow-hidden" id="process">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[minmax(300px,auto)]">
          ...
          {/* Card 1: Strategy (Wide) */}
          <AnimatedSection className="md:col-span-2 rounded-3xl bg-[#0A0A0A] border border-white/10 p-8 flex flex-col justify-center relative overflow-hidden group hover:border-primary/30 transition-colors">
            ...
            {/* Gradient Fade */}
            <div className="absolute right-0 top-0 bottom-0 w-1/3 bg-gradient-to-l from-[#0A0A0A] via-[#0A0A0A]/50 to-transparent pointer-events-none md:hidden" />
          </AnimatedSection>

          {/* Card 2: Visual Design (Tall) */}
          <motion.div 
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ delay: 0.1 }}
            className="md:col-span-1 md:row-span-2 rounded-3xl bg-[#0A0A0A] border border-white/10 p-6 relative overflow-hidden group hover:border-primary/30 transition-all duration-300 min-h-[500px] flex flex-col"
          >
             <div className="relative z-10 flex flex-col h-full">
                ...
                <p className="text-white-dim text-sm mb-8">Pixel-perfect designs ready for any screen size. We focus on interaction, typography, and visual hierarchy.</p>
                
                {/* Phone Mockup */}
                <div className="flex-1 relative flex justify-center w-full mt-auto">
                  <div className="w-full max-w-[220px] bg-black border-[4px] border-[#1a1a1a] rounded-[2.5rem] overflow-hidden relative shadow-2xl ring-1 ring-white/10">
                     {/* Notch */}
          ...
          {/* Card 3: Development */}
          <AnimatedSection delay={0.2} className="md:col-span-1 rounded-3xl bg-[#0A0A0A] border border-white/10 p-8 group hover:border-blue-500/30 transition-colors flex flex-col">
             ...
             <p className="text-white-dim text-sm mb-6">Clean code, fast load times, and SEO optimized architecture.</p>
