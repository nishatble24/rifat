...
const UiUxDesignPage: React.FC = () => {
  ...
  return (
    <div 
      className="min-h-screen bg-[#050505] overflow-x-hidden selection:bg-primary selection:text-black w-full"
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden w-full">
        ...
        <div className="max-w-[90rem] mx-auto px-6 relative z-10 w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold text-white tracking-tight leading-[0.9] mb-8 break-words">
              Engineering <br />
          ...
          <div className="order-1 lg:order-2 relative h-[500px] flex items-center justify-center perspective-[1000px] w-full">
             ...
             >
                ...
                {/* Floating Elements (Badges) - Repositioned for Mobile */}
                <motion.div 
                   initial={{ scale: 0, x: -50 }}
                   animate={{ scale: 1, x: 0 }}
                   transition={{ delay: 0.6, type: "spring" }}
                   className="absolute top-[10%] left-4 lg:top-[20%] lg:left-[-10%] px-4 py-2 bg-black/80 backdrop-blur border border-primary/30 rounded-lg text-primary text-xs font-mono shadow-lg z-20"
                >
                ...
                <motion.div 
                   ...
                   className="absolute bottom-[10%] right-4 lg:bottom-[20%] lg:right-[-15%] px-4 py-2 bg-black/80 backdrop-blur border border-white/10 rounded-lg text-white text-xs font-mono shadow-lg z-20"
                >
